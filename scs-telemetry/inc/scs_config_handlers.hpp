...
scsConfigHandle(Trailer,
                WheelOffset); // it is named offsets in the comment but that attribute doesn't exist so i think it's handled over position, but need to check this
